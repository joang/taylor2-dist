...
\item {\tt endtime}
 \begin{description}
  \item if \verb+NULL+, it is ignored. \item if {\tt step\symbol{95}ctrl\symbol{95}method} is set to
  0, it is also ignored. \item otherwise, if next step is going to be
