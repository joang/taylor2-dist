...
\t" PREFIX_MYCOEF(set_fabs) "(" PREFIX_JET1_1(caux) ",(x)[0]);\\\n\
\t" PREFIX_MYCOEF(nrm2) "(a," PREFIX_JET1_1(caux) ");\\\n\
\t" PREFIX_MYCOEF(set_fabs) "(" PREFIX_JET1_1(caux) ",(x)[1]);\\\n\
\t" PREFIX_MYCOEF(nrm2) "(&" PREFIX_JET1_1(faux) "," PREFIX_JET1_1(caux) ");\\\n\
...
\n\
#define " PREFIX_JET1_1(set_fabs) "(f,x) {\\\n\
\t" PREFIX_MYCOEF(set_fabs) "((f)[0],(x)[0]);\\\n\
\t" PREFIX_MYCOEF(set_fabs) "((f)[1],(x)[1]);\
}\
\n\
...
\n\
void " PREFIX_JET1_1(cleanup) "(void) {\n\
  if (" PREFIX_JET1_1(flag_init_jet_library) "==0) return;\n\
